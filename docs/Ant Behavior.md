...
This explanation describes the current Nuclei v4 GPU ant simulation in 2D and 3D.
...
In V4, detecting a clear food-scent gradient temporarily reduces the outward and sideways launch forces, early outward steering, and random steering. This lets the ant turn toward food before its launch finishes.
