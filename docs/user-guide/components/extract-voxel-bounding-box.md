...
![Extract Voxel Bounding Box with its connected controls and wires.](../assets/components/extract-voxel-bounding-box-wired.png)
...
[Minimizing Transport Networks 1](../examples/03-minimizing-transport-networks-1.md) · [Minimizing Transport Networks 2](../examples/04-minimizing-transport-networks-2.md) · [Attractor Curves 1](../examples/06-attractor-curves-1.md) · [Component reference](README.md)
