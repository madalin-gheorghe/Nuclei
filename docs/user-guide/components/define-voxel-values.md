...
![Define Voxel Values with its connected controls, incoming voxel field, and modified-field output wire.](../.gitbook/assets/define-voxel-values-wired.png)
...
[Gradient Map](../examples/02-gradient-map.md) · [Voxels and fields](../core-concepts/voxels-and-fields.md) · [Component reference](./)
