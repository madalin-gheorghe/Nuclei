...
![Nuclei4 Solver Iterations with its connected controls and wires.](../.gitbook/assets/nuclei4-solver-iterations-wired.png)
...
[Download JSON](../reference/components/nuclei4-solver-iterations.json) · [JSON Schema](../reference/component.schema.json) · [How to read this JSON](../reference/reading-json.md)
