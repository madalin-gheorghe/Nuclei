...
![Particle Division Settings with its connected controls and wires.](../.gitbook/assets/particle-division-settings-wired.png)
...
[Download JSON](../reference/components/particle-division-settings.json) · [JSON Schema](../reference/component.schema.json) · [How to read this JSON](../reference/reading-json.md)
