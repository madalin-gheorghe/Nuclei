...
![Construct Slime Particles with behavior sliders, an incoming voxel field, and a particle-group output wire.](../.gitbook/assets/construct-slime-particles-wired.png)
...
[Slime Intro](../getting-started/first-slime-simulation.md) · [Slime behavior](../core-concepts/slime-behavior.md) · [Define Voxel Values](define-voxel-values.md) · [Component reference](./)

<details>

<summary>Machine-readable reference (JSON)</summary>

[Download JSON](../reference/components/construct-slime-particles.json) · [JSON Schema](../reference/component.schema.json) · [How to read this JSON](../reference/reading-json.md)
