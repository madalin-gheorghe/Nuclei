...
{
    internal static class OldV3Banner
    {
        private const string LegacyAssemblyName = "Nuclei3";
        ...
        {
            if (Rhino.RhinoApp.ExeVersion != 9 || registered)
                return;
        ...
        private static void PaintOldBanners(GH_Canvas canvas)
        {
            ...
            try
            {
                ...
                foreach (IGH_DocumentObject item in document.Objects)
                {
                    ...
                    graphics.DrawString("old v3", BannerFont, TextBrush, banner, CenteredText);
                }
            }
            finally
            {
