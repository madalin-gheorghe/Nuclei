...
namespace Nuclei3
{
    ...
    internal sealed class GpuFullSlimeSolverEngine : IDisposable
    {
        ...
        const string SharedDensityPreviewStatusPath = @"C:\Nuclei\Nuclei-v3\BenchmarkSuite1\NucleiGpuDensityFieldSource.txt";
        const string SharedParticlePreviewStatusPath = @"C:\Nuclei\Nuclei-v3\BenchmarkSuite1\NucleiGpuParticlePreviewSource.txt";
