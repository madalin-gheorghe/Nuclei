...
namespace Nuclei3
{
    public class EnivronmentSettings : GH_Component
    {
        ...
        public override bool Read(GH_IReader reader)
        {
            ...
            {
                // Restore [Diffuse, Range, Decay, Gradual] while reading its
                // chunks, then reorder the same objects so GUIDs, wires and
                // persistent values all survive.
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Nuclei3.Properties.Resources.EnvironmentSettings_Slime;
            }
        }
