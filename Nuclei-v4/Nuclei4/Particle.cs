...
namespace Nuclei4
{
    ...
    public class ParticleList : List<Particle>
    {
        ...
        internal Action CpuStateSynchronizer;
        ...
        internal void EnsureCpuStateCurrent()
        {
            if (CpuStateSynchronizer != null)
            {
                CpuStateSynchronizer();
            }
        }

        internal static void EnsureCpuStateCurrent(List<Particle> particles)
        {
            ParticleList gpuParticles = particles as ParticleList;
            if (gpuParticles != null)
            {
                gpuParticles.EnsureCpuStateCurrent();
            }
        }
    }
