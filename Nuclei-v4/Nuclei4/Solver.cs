...
public class Solver : GH_Component
    {
        ...
        /// </summary>
        public Solver()
          : base("Nuclei4 Solver", "Nuclei4 Solver",
        ...
        void inheritVoxels()
        {
            ...
            Parallel.For(0, activeVoxelCount, ordinal =>
            {
                tempActiveVoxels[ordinal] = createSolverVoxelFromData(inputData, inputData.ActiveFlatIndexAt(ordinal));
            });
