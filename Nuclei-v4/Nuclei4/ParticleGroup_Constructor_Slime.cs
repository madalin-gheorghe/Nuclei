...
namespace Nuclei4
{
    public class ParticleGroup_Constructor_Slime : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            //8
            pManager.AddNumberParameter("Wander", "wander", "Frequency of random directions from 0 (off) to 1 (most frequent)", GH_ParamAccess.item, 0);
            //9
        ...
        public override bool Read(GH_IReader reader)
        {
            ...
            normalizeWanderParameterMetadata();
            return result;
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // Fixed Grasshopper inputs are serialized by ordinal. Archives created
            // with the retired steering mode may restore "Exploration" metadata,
            // so ordinal lookup preserves the wire and value before Read renames it.
        ...
        void normalizeWanderParameterMetadata()
        {
            if (Params.Input.Count <= 8) return;

            IGH_Param parameter = Params.Input[8];
            parameter.Name = "Wander";
            parameter.NickName = "wander";
            parameter.Description = "Frequency of random directions from 0 (off) to 1 (most frequent)";
        }
